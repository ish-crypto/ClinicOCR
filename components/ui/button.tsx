...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_2px_0_var(--stamp-deep)] hover:bg-primary/90 hover:-translate-y-px active:translate-y-px active:shadow-none",
        outline:
          "border-ink/25 bg-paper text-ink shadow-[0_1.5px_0_rgb(35_43_54/0.18)] hover:bg-secondary hover:text-foreground active:translate-y-px active:shadow-none aria-expanded:bg-secondary aria-expanded:text-foreground",
        secondary:
        ...
        destructive:
          "bg-rxred/10 text-rxred ring-1 ring-rxred/25 hover:bg-rxred/20 focus-visible:border-rxred/40 focus-visible:ring-rxred/20",
